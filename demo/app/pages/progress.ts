  ...
  render() {
    return html`
      ...
      <div class="section">
        ...
        <metro-progress-bar .value=${this.progressValue} showLabel></metro-progress-bar>
        ...
        <div class="controls">
          ...
          <metro-button @click=${this.#resetProgress}>
            Reset
          </metro-button>
        </div>
      ...
      <div class="section">
        ...
        <div class="code-example">
          &lt;metro-progress-ring size="small"&gt;&lt;/metro-progress-ring&gt;<br/>
          &lt;metro-progress-ring size="normal"&gt;&lt;/metro-progress-ring&gt;<br/>
          &lt;metro-progress-ring size="large"&gt;&lt;/metro-progress-ring&gt;
        </div>
      </div>
