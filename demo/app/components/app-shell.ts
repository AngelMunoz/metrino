...
const SECTIONS: Section[] = [
  { id: "buttons", title: "Buttons", icon: "check", description: "Button controls" },
  { id: "input", title: "Input", icon: "edit", description: "Form inputs" },
  { id: "datetime", title: "Date & Time", icon: "calendar", description: "Date/time pickers" },
  { id: "progress", title: "Progress", icon: "refresh", description: "Progress indicators" },
  { id: "tiles", title: "Tiles", icon: "tiles", description: "Live tiles" },
  { id: "layout", title: "Layout", icon: "grid", description: "Layout containers" },
  { id: "navigation", title: "Navigation", icon: "menu", description: "Navigation components" },
  {
    id: "selection",
    title: "Selection",
    icon: "list",
  ...
  { id: "primitives", title: "Primitives", icon: "page", description: "Basic elements" },
  { id: "dialogs", title: "Dialogs", icon: "new-window", description: "Dialogs & overlays" },
  { id: "animations", title: "Animations", icon: "rotate", description: "Motion & transitions" },
];
...
export class MetrinoAppShell extends LitElement {
  static styles = css`
    ...
    .theme-btn {
      ...
      transition: background var(--metro-transition-fast, 167ms) var(--metro-easing);
    }
    ...
    .settings-panel {
      ...
      transition: transform var(--metro-transition-normal, 250ms) var(--metro-easing);
      z-index: 1001;
    ...
    .accent-swatch {
      ...
      border: none;
      cursor: pointer;
      transition: transform var(--metro-transition-fast, 167ms) var(--metro-easing);
    }
      ...
      <div class="app-container">
        ...
        <div class="settings-panel ${this.settingsOpen ? "open" : ""}">
          <div class="settings-title">
            <span>Settings</span>
            <button class="close-btn" @click=${this.#toggleSettings}>&times;</button>
          </div>
          ...
          <div class="settings-section">
            ...
            <div class="accent-grid">
              ${ACCENT_COLORS.map(
                ({ name, hex }) => html`
                  <button
                    class="accent-swatch ${this.currentAccent === name ? "active" : ""}"
