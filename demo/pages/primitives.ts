...
export class MetrinoPrimitivesPage extends LitElement {
  ...
  render() {
    return html`
      ...
      <section class="section">
        ...
        <div class="demo-row">
          <metro-text-block bold italic underline
            >Bold, Italic & Underlined</metro-text-block
          >
        </div>
        <api-docs component="MetroTextBlock"></api-docs>
      </section>
      ...
      <section class="section">
        ...
        <api-docs component="MetroIcon"></api-docs>
      </section>
      ...
      <section class="section">
        ...
        <metro-expander title="Click to expand">
          <metro-text-block
            >This content was hidden. The expander component allows you to show
            and hide content with a smooth animation.</metro-text-block
          >
        </metro-expander>
        <metro-expander title="Another expander" expanded>
          <metro-text-block
            >This expander starts expanded. You can collapse it by clicking the
            header.</metro-text-block
          >
        </metro-expander>
        <api-docs component="MetroExpander"></api-docs>
      </section>
      ...
      <section class="section">
        ...
        <api-docs component="MetroInfoBar"></api-docs>
      </section>
      ...
      <section class="section">
        ...
        <api-docs component="MetroPersonPicture"></api-docs>
      </section>
      ...
      <section class="section">
        ...
        <div class="tooltip-demo">
          <metro-button
            id="tooltip-top"
            @mouseenter=${this.#showTooltipTop}
            @mouseleave=${this.#hideTooltip}
            >Top Tooltip</metro-button
          >
          <metro-button
            id="tooltip-bottom"
            @mouseenter=${this.#showTooltipBottom}
            @mouseleave=${this.#hideTooltip}
            >Bottom Tooltip</metro-button
          >
          <metro-button
            id="tooltip-left"
            @mouseenter=${this.#showTooltipLeft}
            @mouseleave=${this.#hideTooltip}
            >Left Tooltip</metro-button
          >
          <metro-button
            id="tooltip-right"
            @mouseenter=${this.#showTooltipRight}
            @mouseleave=${this.#hideTooltip}
            >Right Tooltip</metro-button
          >
        </div>
        <metro-tooltip
          id="demo-tooltip"
        ...
        ></metro-tooltip>
        <api-docs component="MetroTooltip"></api-docs>
      </section>
      ...
      <section class="section">
        ...
        <div class="demo-row">
          <metro-border
            border-thickness="2"
            border-color="var(--metro-foreground, #fff)"
            corner-radius="8"
            padding="16"
          >
        ...
        <api-docs component="MetroBorder"></api-docs>
      </section>
      ...
      <section class="section">
        ...
        <api-docs component="MetroImage"></api-docs>
      </section>
      ...
      <section class="section">
        ...
        <div class="demo-box">
          ...
          <metro-rich-text-block
            content="<strong>Bold</strong>, <em>Italic</em>, and <a href='#'>links</a> are supported."
          ></metro-rich-text-block>
        </div>
        <div class="demo-box" style="margin-top: 12px;">
          ...
          <metro-rich-text-block
            max-lines="2"
            content="This is a very long text that should be truncated after two lines using CSS line-clamp. The overflow will be hidden and the text will end with an ellipsis if the browser supports it properly."
          ></metro-rich-text-block>
        </div>
        <div class="demo-box" style="margin-top: 12px;">
        ...
        <api-docs component="MetroRichTextBlock"></api-docs>
      </section>
      ...
      <section class="section">
        ...
        <api-docs component="MetroMediaElement"></api-docs>
      </section>

      <section class="section">
        <h2>metro-context-menu</h2>
        <p
          style="color: var(--metro-foreground-secondary, rgba(255, 255, 255, 0.6)); margin-bottom: 12px;"
        >
          Right-click on the box below to show the context menu. Long-press also
        ...
        <metro-context-menu target="#context-target">
          <div slot="item">
            <metro-icon icon="edit" size="small"></metro-icon> Edit
          </div>
          <div slot="item">
            <metro-icon icon="copy" size="small"></metro-icon> Copy
          </div>
          <div slot="item">
            <metro-icon icon="paste" size="small"></metro-icon> Paste
          </div>
          <div slot="item" class="menu-divider"></div>
          <div slot="item">
            <metro-icon icon="delete" size="small"></metro-icon> Delete
          </div>
        </metro-context-menu>
        <api-docs component="MetroContextMenu"></api-docs>
      </section>
    `;
  }
  ...
  #showTooltip(target: Element, placement: string): void {
    const tooltip = this.shadowRoot?.querySelector(
      "#demo-tooltip",
    ) as HTMLElement & { showDelayed: (el: Element, delay?: number) => void };
    if (tooltip) {
  ...
  #hideTooltip(): void {
    const tooltip = this.shadowRoot?.querySelector(
      "#demo-tooltip",
    ) as HTMLElement & { hideImmediate: () => void };
    if (tooltip) {
