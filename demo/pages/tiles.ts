...
export class MetrinoTilesPage extends LitElement {
  ...
  firstUpdated(): void {
    this.#cycleTile =
      this.shadowRoot?.querySelector("#cycle-tile-demo") || null;
  ...
  #updateLiveTile(): void {
    ...
    if (this.#liveTile) {
      const items = [
        ...
        {
          title: "Weather",
          message: `${Math.floor(Math.random() * 30 + 50)}°F`,
        },
        {
          title: "Email",
          message: `${Math.floor(Math.random() * 10)} new messages`,
        },
      ];
  ...
  render() {
    return html`
      ...
      <div class="section">
        ...
        <p class="label">
          Click tiles to flip them (3D rotation with perspective: 1000px)
        </p>
        ...
        <div class="code-example">
          ...
          &lt;div slot="front"&gt;Front Content&lt;/div&gt; &lt;div
          slot="back"&gt;Back Content&lt;/div&gt; &lt;/metro-flip-tile&gt;
          Properties: - size: "small" | "medium" | "wide" | "large" - flipped:
          boolean Events: - @flipped: { detail: { flipped: boolean } }
        </div>
        <api-docs component="MetroFlipTile"></api-docs>
      </div>
      ...
      <div class="section">
        ...
        <div class="code-example">
          ...
          interval="${this.cycleInterval}"&gt; &lt;div slot="front"&gt;Base
          Content&lt;/div&gt; &lt;div slot="cycle"&gt;Item 1&lt;/div&gt; &lt;div
          slot="cycle"&gt;Item 2&lt;/div&gt; &lt;div slot="cycle"&gt;Item
          3&lt;/div&gt; &lt;/metro-cycle-tile&gt; Properties: - size: "medium" |
          "wide" - interval: number (default: 3000)
        </div>
        <api-docs component="MetroCycleTile"></api-docs>
      </div>
      ...
      <div class="section">
        ...
        <div class="code-example">
          &lt;metro-iconic-tile size="medium" icon="calendar" title="Calendar"
          count="12" badge="New" &gt;&lt;/metro-iconic-tile&gt; Properties: -
          size: "small" | "medium" | "large" - icon: string - title: string -
          count: number - badge: string
        </div>
        <api-docs component="MetroIconicTile"></api-docs>
      </div>
      ...
      <div class="section">
        ...
        <div class="controls">
          ...
          <metro-button @click=${this.#resetLiveTile}> Reset </metro-button>
        </div>

        <div class="code-example">
          const tile = document.querySelector('#live-tile'); tile.setItems([ {
          title: "New Message", message: "Hello!" }, { title: "Update", message:
          "Version 2.0" }, ]); Methods: - setItems(items: LiveTileItem[]): void
          Properties: - size: "small" | "medium" | "wide" | "large" - count:
          number - badge: string - interval: number (0 = random 6-10s)
        </div>
        <api-docs component="MetroLiveTile"></api-docs>
      </div>
      ...
      <div class="section">
        ...
        <div class="code-example">
          &lt;metro-tile-grid columns="4"&gt; &lt;!-- Tiles auto-layout based on
          size --&gt; &lt;metro-flip-tile
          size="small"&gt;...&lt;/metro-flip-tile&gt; &lt;metro-flip-tile
          size="medium"&gt;...&lt;/metro-flip-tile&gt; &lt;metro-flip-tile
          size="wide"&gt;...&lt;/metro-flip-tile&gt; &lt;metro-flip-tile
          size="large"&gt;...&lt;/metro-flip-tile&gt; &lt;/metro-tile-grid&gt;
          Properties: - columns: number (default: 4) Tile Sizes (70px unit + 8px
          gap): - small: 70x70 (1x1 grid cells) - medium: 150x150 (2x2 grid
          cells) - wide: 310x150 (4x2 grid cells) - large: 310x310 (4x4 grid
          cells)
        </div>
