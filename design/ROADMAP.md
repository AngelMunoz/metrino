...
- Hub programmatic API per design/HUB_API_PLAN.md (part attributes, sections, selectedIndex, selectionchanged, scrollToSection with Metro-eased smooth scroll, opt-in snap, keyboard + ARIA, overscroll containment)
