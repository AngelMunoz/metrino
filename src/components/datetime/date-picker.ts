...
export class MetroDatePicker extends LitElement {
   ...
   * native ISO date strings; unparseable programmatic values report badInput.
   * @returns void
   */
  #updateState(): void {
    updateFormControlState(
      this.#internals,
      this.value,
      dateValidation({ value: this.value, required: this.required && !this.disabled }),
      this.#input,
    );
  }
...
declare global {
  interface HTMLElementTagNameMap {
    "metro-date-picker": MetroDatePicker;
  }
}
